...
<body >
	...
	<section class="main">
		<article>
            ...
            <form action="../../modelos/admin/Refugio.php?op=refugio" method="POST">
            ...
            <input type="text" name="direccion" placeholder="Infrese su dirección" required>
            </p>
            <p>
            <label for="">Telefono</label>
            <input type="text" name="telefono" placeholder="Infrese su teléfono" required>
            </p>
            <p>
            <label for="">Capacidad</label>
            <input type="email" name="capacidad" placeholder="Infrese la capacidad" required>
            </p>
            <p>
            <label for="">Condición</label>
            <input type="text" name="condicion" placeholder="condición" required>
            </p>
