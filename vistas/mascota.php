              ...
              <div class="col-md-12 fondo">   <br> <br> <br>
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title" style="font-family: 'Baloo Bhai', cursive">Mascota <button class="btn btn-dark" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
