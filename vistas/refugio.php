                  ...
                  <div class="box ">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <label>Nombre:</label>
                          <input type="hidden" name="idrefugio" id="idrefugio">
                          ...
                          <input type="hidden" name="idrefugio" id="idrefugio">
                          <input type="text" class="form-control" name="capacidad" id="capacidad" maxlength="50" placeholder="capacidad" required>
                          </div>
...
require 'footer.php';
?>
<script src="Scripts/refugio.js"></script>
