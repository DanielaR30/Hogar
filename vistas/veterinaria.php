                  ...
                  <div class="box ">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <label>Nombre:</label>
                          <input type="hidden" name="idveterinaria" id="idveterinaria">
                          ...
                          <input type="hidden" name="idveterinaria" id="idveterinaria">
                          <input type="text" class="form-control" name="funcionario" id="funcionario" maxlength="50" placeholder="Nombre del funcionario" required>
                          </div>
...
require 'footer.php';
?>
<script src="Scripts/veterinaria.js"></script>
